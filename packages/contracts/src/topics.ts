...
export const TOPIC_OWNERS = {
  ...
  [KAFKA_TOPICS.orderOrderEventsRetry5s]: "platform",
  [KAFKA_TOPICS.orderOrderEventsRetry30s]: "platform",
  [KAFKA_TOPICS.orderOrderEventsRetry5m]: "platform",
...
export const TOPIC_KEY_STRATEGY = {
  ...
  [KAFKA_TOPICS.orderOrderEventsRetry5s]: "orderId",
  [KAFKA_TOPICS.orderOrderEventsRetry30s]: "orderId",
  [KAFKA_TOPICS.orderOrderEventsRetry5m]: "orderId",
